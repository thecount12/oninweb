...
def add_batch_view(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            get_cart_name = Cartridge.objects.get(id=cartridge)
            pk = ("cartridge_type name {}".format(get_cart_name))  # pk accurate list id -1
            print("pk is {}".format(pk))
            pk_qty = get_cart_name.quantity  # pk quantity
